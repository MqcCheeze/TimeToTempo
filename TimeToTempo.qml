...
MuseScore {
      ...
      function calculateTempo() {
            ...
            // Read input times
            var startTime = startingTimeValue.text;
            var endTime = endingTimeValue.text;
